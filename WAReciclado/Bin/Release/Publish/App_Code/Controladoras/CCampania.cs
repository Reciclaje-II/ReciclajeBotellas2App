...
public class CCampania : System.Web.UI.Page
{
    ...
    public ERVoto Obtener_RVoto_O_Codigo_Campania_CC(string codigoUsuario, string nombreCampania)
    {
        try
        {
            voto = lnServicio.Obtener_RVoto_O_Codigo_Campania(codigoUsuario, nombreCampania);
        }
